...
function selectModule(
  ...
  if (
    ...
    if (
      ...
      if (saAppointmentsView) {
        saAppointmentsView.style.display = "block";
      }
  ...
  if (moduleName === "Suppliers") {
    ...
    if (typeof loadSASuppliers === "function") loadSASuppliers();
    return;
  }
  ...
  if (moduleName === "Products") {
    ...
    if (typeof loadSAProducts === "function") loadSAProducts();
    return;
  }
  ...
  if (moduleName === "Inventory") {
    ...
    if (typeof loadSAInventory === "function") loadSAInventory();
    return;
  }
  ...
  if (
    ...
    const reportsEyebrow =
      document.getElementById(
        "reportsEyebrow"
      );

    if (reportsEyebrow) {
      reportsEyebrow.textContent =
        currentRole === "SA"
          ? "SERVICE ADVISOR ANALYTICS"
          : currentRole === "PM"
            ? "PM ANALYTICS"
            : "CRM ANALYTICS";
    }
    ...
    if (
      ["PM", "SA", "BM", "DIREK"].indexOf(currentRole) !== -1 &&
      typeof loadPMReports === "function"
    ) {
      loadPMReports();
    }
